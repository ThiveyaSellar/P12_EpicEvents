...
class RegisterForm:
    ...
    def __init__(self, email, password, password2, first_name, last_name,
                 phone, team):
        self.email = email
...
"""
ET NE PAS OULIER DE BIEN RETURN DES FONCTIONS D'AUTRES CONTROLLERS DERRIÈRES POUR DÉCLENCHER LA LOGIQUE DE TOUS LES MENUS !
"""