...
sentry_logging = LoggingIntegration(
    ...
    event_level=logging.INFO  # Crée événements Sentry pour WARNINGS et ERROR
)
...
def main():
    ...
    # Vérifier qu'il y a un token identifiant l'utilisateur et s'il est valide
    ...
    while not connected:
        ...
        # Vérification de l'exécution de login
